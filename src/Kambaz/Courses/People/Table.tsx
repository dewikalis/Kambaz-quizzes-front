      ...
      <Table striped>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2022-01-15</td>
            <td className="wd-total-activity">5:15:30</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-05-22</td>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-08-12</td>
            <td className="wd-total-activity">8:45:25</td>
          </tr>
        </tbody>
      </Table>
    </div>
